/*
 *  switches.cpp is a part of SBK_SWITCHES_TEST (Version 0) code for testing switches and push buttons
 *  connections used in many Ghostbusters props replica. 
 *  Copyright (c) 2024 Samuel Barabé
 *
 *  See this page for reference <https://github.com/sbarabe/SBK_PROTONPACK_CORE/tree/main/Tools/SBK_SWITCHES_TEST>.
 *
 *  SBK_SWITCHES_TEST is free software: you can redistribute it and/or modify it under the terms
 *  of the GNU General Public License as published by the Free Software Foundation, either version
 *  3 of the License, or (at your option) any later version.
 *
 *  SBK_SWITCHES_TEST is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
