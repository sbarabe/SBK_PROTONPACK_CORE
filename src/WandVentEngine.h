/*
 *  WandVentEngine.h is a part of SBK_PROTONPACK_CORE (VERSION 2.1) code for animations of a Proton Pack replica
...
#ifndef WANDVENTENGINE_H
#define WANDVENTENGINE_H
...
{
public:
    WandVent(Adafruit_NeoPixel &strip, uint8_t start, uint8_t end);
    void begin();
    void update();
    void clear();
