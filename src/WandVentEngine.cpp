/*
 *  WandVentEngine.cpp is a part of SBK_PROTONPACK_CORE (VERSION 2.1) code for animations of a Proton Pack replica
...
WandVent::WandVent(Adafruit_NeoPixel &strip, uint8_t start, uint8_t end)
...
void WandVent::begin() { clear(); }

void WandVent::update()
{
...
void WandVent::setColor(uint8_t red, uint8_t green, uint8_t blue)
{
    _redTracker = red;
    _greenTracker = green;
    _blueTracker = blue;
...
void WandVent::boot(int16_t boot_time, bool init)
{
...
void WandVent::warming(int16_t warming_time, bool init)
{
    int16_t redIncrement = 1;
    int16_t blueIncrement = 20;
...
void WandVent::cooling(int16_t cooling_time, bool init)
{
...
void WandVent::shutdown(int16_t cooling_time, bool init)
{
...
bool WandVent::_rampColor(int16_t *colorTracker, int16_t rampTime, bool init, int16_t *initTracker, int16_t tg, int16_t *interval, int16_t increment, unsigned long *prevTime)
{
...
int16_t WandVent::_ramp_parameter(int16_t param, int16_t ini, int16_t tg, int16_t incr)
{
